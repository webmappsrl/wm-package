...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('apps', function (Blueprint $table) {
            ...
            // ==================== POIS TAB ====================
            $table->decimal('poi_min_radius', 0, 0)->default(0.5);
            $table->decimal('poi_max_radius', 0, 0)->default(1.2);
            $table->decimal('poi_icon_zoom', 0, 0)->default(16);
            $table->decimal('poi_icon_radius', 0, 0)->default(1);
            $table->decimal('poi_min_zoom', 0, 0)->default(13);
            $table->decimal('poi_label_min_zoom', 0, 0)->default(10.5);
