...
class EcTrackExcelExporter implements FromCollection, WithHeadings, WithMapping
{
    ...
    public function map($track): array
    {
        ...
        return [
            ...
            $track->classifyField($track, 'distance')['currentValue'],
            $track->classifyField($track, 'ascent')['currentValue'],
            $track->classifyField($track, 'descent')['currentValue'],
            $track->classifyField($track, 'ele_from')['currentValue'],
            $track->classifyField($track, 'ele_to')['currentValue'],
            $track->classifyField($track, 'ele_min')['currentValue'],
            $track->classifyField($track, 'ele_max')['currentValue'],
            $track->classifyField($track, 'duration_forward')['currentValue'],
            $track->classifyField($track, 'duration_backward')['currentValue'],
