...
namespace Wm\WmOsmclient\Http;

use Illuminate\Support\Facades\Http;
use Wm\WmOsmclient\Exceptions\OsmClientException;
use Wm\WmOsmclient\Exceptions\OsmClientExceptionNodeHasNoLat;
use Wm\WmOsmclient\Exceptions\OsmClientExceptionNodeHasNoLon;
use Wm\WmOsmclient\Exceptions\OsmClientExceptionNoElements;
use Wm\WmOsmclient\Exceptions\OsmClientExceptionNoTags;
use Wm\WmOsmclient\Exceptions\OsmClientExceptionRelationHasInvalidGeometry;
use Wm\WmOsmclient\Exceptions\OsmClientExceptionRelationHasNoMembers;
use Wm\WmOsmclient\Exceptions\OsmClientExceptionRelationHasNoNodes;
use Wm\WmOsmclient\Exceptions\OsmClientExceptionRelationHasNoRelationElement;
use Wm\WmOsmclient\Exceptions\OsmClientExceptionRelationHasNoWays;
use Wm\WmOsmclient\Exceptions\OsmClientExceptionWayHasNoNodes;
 ...
 *
 * TRY ON TINKER
 * $s = Wm\WmOsmclient\Facades\OsmClient::getGeojson('node/770561143');
 * $s = Wm\WmOsmclient\Facades\OsmClient::getGeojson('way/145096288');
 * $s = Wm\WmOsmclient\Facades\OsmClient::getGeojson('relation/14336243');
 */
class OsmClient
{
    /**
