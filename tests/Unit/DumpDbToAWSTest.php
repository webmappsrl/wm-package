...
class DumpDbToAWSTest extends TestCase
{
    ...
    public function testDumpDbToAwsSuccess()
    {
    ...
    public function testDumpDbToAwsFailsOnDumpCreation()
    {
    ...
    public function testDumpDbToAwsFailsOnEmptyDumpFile()
    {
    ...
    public function testDumpDbToAwsFailsOnUpload()
    {
